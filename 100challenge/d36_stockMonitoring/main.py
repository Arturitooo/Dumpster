...
print(befYesterdayClosingPrice)

#TODO 3. - Find the positive difference between 1 and 2. e.g. 40 - 20 = -20, but the positive difference is 20. Hint: https://www.w3schools.com/python/ref_func_abs.asp
differenceClosingPrice = abs(float(yesterdayClosingPrice) - float(befYesterdayClosingPrice))
print(differenceClosingPrice)
...
differencePercentage = 6 #toberemoved later
